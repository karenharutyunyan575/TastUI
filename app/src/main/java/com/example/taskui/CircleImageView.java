...
public class CircleImageView extends AppCompatImageView {
    ...
    private int getCircleBackgroundColor() {
        return mCircleBackgroundColor;
    }

    private void setCircleBackgroundColor(@ColorInt int circleBackgroundColor) {
    ...
    private void setCircleBackgroundColorResource(@ColorRes int circleBackgroundRes) {
